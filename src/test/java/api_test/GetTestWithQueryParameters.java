...
public class GetTestWithQueryParameters {
    ...
    @Test
    public void getTestWithQueryParameters () {
        LOGGER.info("--------API Test: Read(Get) All Users With Query Parameters------");

        // Specify the base URL or the Endpoint of the rest API
        ...
        // Get the Jason Path object instance from the response
        ...
        LOGGER.info("--------End Test: Read(Get) All Users With Query Parameters ------");
    }
